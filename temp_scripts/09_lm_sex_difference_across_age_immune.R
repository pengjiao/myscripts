...
## whenever you do lm, you need to make sure your "y" is normal like, otherwise, do some transformation on it
temp5.log <- mutate_each(temp5, funs(log10(. + 0.0001)), T:ncMo.cMO)
...
##
wrap_plots(pstlist)
ggsave(filename = "nc_scd_amci_ad1_immune.pdf", width = 16, height = 18)
# ggsave(filename = "nc_immune.pdf", width = 16, height = 18)
# ggsave(filename = "scd_immune.pdf", width = 16, height = 18)
# ggsave(filename = "amci_immune.pdf", width = 16, height = 18)
# ggsave(filename = "ad1_immune.pdf", width = 16, height = 18)
# ggsave(filename = "ad2_immune.pdf", width = 16, height = 18)
